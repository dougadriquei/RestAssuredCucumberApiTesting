 Feature: GetAccounts
  ...
  Scenario: Verify an Applicant's account
  ...
  Scenario: Verify a Luke's account
  ...
  Scenario: Verify a Darth's account
  ...
  Scenario: Verify an invalid account
